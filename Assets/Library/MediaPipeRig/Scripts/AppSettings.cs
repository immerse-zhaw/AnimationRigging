...
namespace Library.MediaPipeRig
{
  ...
  public class AppSettings : ScriptableObject
  {
    ...
    [SerializeField] private int _glogMinloglevel = Mediapipe.Glog.Minloglevel;
    [SerializeField] private int _glogStderrthreshold = Mediapipe.Glog.Stderrthreshold;
    [SerializeField] private int _glogV = Mediapipe.Glog.V;
    ...
    {
      Mediapipe.Glog.Logtostderr = true;
      Mediapipe.Glog.Minloglevel = _glogMinloglevel;
      Mediapipe.Glog.Stderrthreshold = _glogStderrthreshold;
      Mediapipe.Glog.V = _glogV;
    }
